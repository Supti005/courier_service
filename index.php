  ...
  <header class="site-navbar py-3 js-site-navbar site-navbar-target" role="banner" id="site-navbar">
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <h1 class="mb-0"><a href="index.php" class="text-white h5 mb-0">RAPID ROUTE SERVICES</a></h1>
        </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        ...
        <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
          ...
          <p data-aos="fade-up" data-aos-delay="200"><a href="request.php" class="btn btn-primary py-3 px-5 text-white">Send Request</a></p>
      ...
      <div class="row">
        <div class="col-md-7 mb-5">
          ...
          <form action="#" class="p-5 bg-white" method="post">
            ...
            <div class="row form-group">
              <div class="col-md-12">
                <input type="button" onclick="addContactMessage(this.form)" value="Send Message" class="btn btn-primary py-2 px-4">
              </div>
            </div>
