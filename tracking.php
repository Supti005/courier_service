    ...
    <header class="site-navbar py-3 js-site-navbar site-navbar-target" role="banner" id="site-navbar">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <h1 class="mb-0"><a href="index.php" class="text-white h5 mb-0">RAPID ROUTE</a></h1>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 mb-5">
                    ...
                    ?>
                        <article class="card mt-5" style="border: 2px solid #1d2298">
                            <header class="card-header text-white" style="background-color: #1d2298; border-radius: 0px;">
                                Orders /
                                Tracking </header>
                            <div class="card-body">
                                ...
                                <article class="card">
                                    <div class="card-body row">
                                        ...
                                        <div class="col"> <strong>Pickup Location</strong>
                                            <br>
                                            <?php
                                ...
                                <div class="row mt-3">
                                    ...
                                    <a href="admin/getbill.php?customer_id=<?php echo $_SESSION['customer']; ?>" class="btn btn-darkblue">Print Bill<i class="fa-solid fa-file-pdf"></i></a>
                                </div>
                            </div>
                        </article>
                    <?php } ?>
